...
(function() {
  ...
  Snipe = (function() {
    ...
    Snipe.prototype.makeSettings = function(settings) {
      ...
      this.defaults.css = $.extend({}, this.defaults.css, settings && settings.css, forcedCss);
...
$('.element').on("click" , function(){
		...
		var s = source.substring(7);
		var dataSource = $(this).attr('data-zoom');
		var tag = $(this).attr('id');
		console.log(s);
		
		$('#photoGal').hide().html('<img style="max-height:50%; max-width:50%; " src="images/' + s + '" data-zoom=" ' + dataSource + '" id="snipe" />' ).fadeIn('slow');
